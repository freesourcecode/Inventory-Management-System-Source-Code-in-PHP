...
<title><?php echo $title; ?> | GC Appliance Centrum</title>
   ...
   <div class="col-md-4">
    <div class="row "> 
     <p > 
        ...
        <h1 align="center" ><b>GC <br/>Appliance <br/>Centrum</b></h1>
        </a>
    </p>
...
<div class="col-md-10 col-md-push-1 "> 
  ...
  // check_message(); ?>
            ...
            <div class="row">
              <div class="col-lg-8">
                <div class="panel panel-default">
                  ...
                  <b><?php  
                  $q = $_REQUEST['q'] ;
                  echo  $q . (isset($_GET['category']) ?  '  |  ' .$_GET['category'] : '' )?></b> 
                  </div>
           ...
           <div class="col-lg-4">
            ...
            <footer class="panel-footer" style="background-color:blue;color:white" >
              <p align="left" >&copy; GC Appliance Centrum Corp</p>
           </footer>
      </div>
