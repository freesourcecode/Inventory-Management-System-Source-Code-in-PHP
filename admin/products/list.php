<?php
		...
		<div class="row">
        	...
        	<!-- /.col-lg-12 -->
			  ...
			  <tbody>
				  	<?php 
				  		$query = "SELECT * FROM `tblpromopro` natural join tblproduct natural join tblcategory";
				  		$mydb->setQuery($query);
				    ...
				    echo '<td >
							...
							<img  title=" responsive-image" width="50px" height="50px" src="'. web_root.'admin/products/'.$result->IMAGES . '">
							</a></td>'; 	
