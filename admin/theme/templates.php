        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >GC Appliance Centrum Corp</a>
            </div>
            <!-- /.navbar-header -->
  ...
  <div id="page-wrapper">
            ...
            <div class="row" >
                ...
                <div class="col-lg-12"> 
                    ...
                    <?php 
                    if ($title<>'Dashboard'){
                       echo   ' <a href="'. web_root.'admin/index.php" title="Dashboard" >Dashboard</a>  / 
    ...
    <!-- /#wrapper -->
      ...
      <footer><p align="Left">&copy; GC Appliance Centrum Corp </p></footer>
